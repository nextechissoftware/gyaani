...
<body>
    ...
    <div class="container-fluid p-0">
        <div class="owl-carousel header-carousel position-relative">
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                ...
                                <h1 class="display-3 text-white animated slideInDown">Empowering Young Minds for a Brighter Tomorrow</h1>
                                <p class="fs-5 text-white mb-4 pb-2"> We provide a nurturing environment where students develop academic excellence,
                                    leadership skills, creativity, and strong moral values to succeed in an ever-changing world.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="img/hero2.jpeg" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(24, 29, 56, .7);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class="text-primary text-uppercase mb-3 animated slideInDown">Shaping Future Leaders</h5>
                                <h1 class="display-3 text-white animated slideInDown">Inspiring Excellence Through Knowledge and Values</h1>
                                <p class="fs-5 text-white mb-4 pb-2">Our dedicated faculty and modern learning environment empower every student to achieve academic excellence while building confidence, discipline, and character.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="img/hero3.jpeg" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(24, 29, 56, .7);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class="text-primary text-uppercase mb-3 animated slideInDown">A Legacy of Learning</h5>
                                <h1 class="display-3 text-white animated slideInDown">Where Every Student Discovers Their True Potential</h1>
                                <p class="fs-5 text-white mb-4 pb-2">We believe in nurturing curious minds through innovative teaching, holistic development, and a safe, supportive environment for lifelong success.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="img/director.jpeg" alt="" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4">At Gyaana International School, we believe that true education is a collaborative journey where students, 
                        ...
                        With the continuous support and trust of parents, we are able to create a competitive and nurturing environment
                        that encourages learning, discipline, respect and values. Our dedicated teachers play a vital role in 
                        shaping young minds with their commitment, passion, and guidance, ensuring that every child grows 
                        academically as well as personally.<br/>
                        The steady growth and success of our school are the result of strong teamwork and effective management 
                        support. The management's vision and encouragement empower us to provide quality education and modern 
                        opportunities for our students. <br/>
                        Together, we strive to build a culture of excellence where hard work, respect, and innovation are valued. 
                        As we move forward, we remain committed to fostering an environment where every child can achieve their 
                        full potential and contribute positively to society.</p>
                        <div class="row gy-2 gx-4 mb-4">
                            ...
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Smart Classrooms</p>
                            </div>

                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Sports & Physical Education</p>
                            </div>

                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Computer & Science Labs</p>
                            </div>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4">Mr. Gaurav Kumar Agarwal</h1>
                        <p class="mb-4">
                            ...
                            <br><br>
                            Our committed teachers work closely with students to encourage academic success, creativity, confidence, and strong moral values. Together with parents, we strive to shape responsible, compassionate, and lifelong learners who are prepared to meet the challenges of tomorrow with confidence.
                        </p>
                        <div class="row gy-2 gx-4 mb-4">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Character Building</p>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Parent-School Partnership</p>
                            </div>
    ...
    <div class="container-xxl py-5 category">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Our Academic Programs</h1>
            </div>
            ...
            <div class="row g-3">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-12 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                ...
                                <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin:1px;">
                                    <h5 class="m-0">Pre-Primary</h5>
                                    <small class="text-primary">Nursery • LKG • UKG</small>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.3s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                ...
                                <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin:1px;">
                                    <h5 class="m-0">Primary School</h5>
                                    <small class="text-primary">Classes I - V</small>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                ...
                                <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin:1px;">
                                    <h5 class="m-0">Upper Primary</h5>
                                    <small class="text-primary">Classes VI - VIII</small>
                                </div>
                            </a>
                        </div>
                ...
                <div class="col-lg-5 col-md-6 wow zoomIn" data-wow-delay="0.7s" style="min-height:350px;">
                    <a class="position-relative d-block h-100 overflow-hidden" href="">
                        ...
                        <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin:1px;">
                            <h5 class="m-0">Holistic Development</h5>
                            <small class="text-primary">Sports • Arts • Values</small>
                        </div>
                    </a>
                </div>
